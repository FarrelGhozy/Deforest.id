...
ground surveys, supporting the FOLU Net Sink 2030 target.
...
\cite{fao2022sofo}. Protected forests (\textit{hutan lindung}) --
...
\cite{unfccc2022indonesia} -- three times the 2~ha threshold above
...
Indonesian law (UU~No.~41/1999). Norway's NICFI program provides
...
multi-spectral imagery (10~m, 5-day revisit, open access) with a
U-Net deep learning architecture. The pipeline is fully autonomous:
